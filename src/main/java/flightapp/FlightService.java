...
public class FlightService {
   ...
   */
  public static String execute(QueryAbstract q, String command) {
    ...
    // create
      ...
      if (tokens.length == 4) {
        ...
        response = q.create(username, password, initAmount);
      } else {
   ...
   * @throws IOException
   */
  private static void menu(QueryAbstract q) throws IOException {
    while (true) {
